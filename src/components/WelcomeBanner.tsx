...
export function WelcomeBanner() {
  return (
    <div className="bg-primary text-white p-3 lg:px-9   border-b-8 border-b-yellow-300 shadow-md hover:shadow-lg">
      <div className="flex items-center justify-between  max-w-7xl mx-auto">
        {/* Welcome Text */}
        <h4 className="text-xs sm:text-sm lg:text-xl font-mono shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 break-words max-w-[200px] sm:max-w-none text-center">
