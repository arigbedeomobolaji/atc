...
export function WelcomeBanner() {
  return (
    <div className="bg-blue-950/95 text-white flex items-center justify-between p-3 md:px-5  border-b-8 border-b-yellow-300 shadow-md hover:shadow-lg">
      {/* Welcome Text */}
      <h1 className="text-xs sm:text-sm md:text-xl font-mono shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 break-words max-w-[200px] sm:max-w-none text-center">
